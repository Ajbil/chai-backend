//I see that here in this file i am setting up some configurations using .use(0 like its my backend so frontend will provide data now data can come in anyformat like json, raw, urlencoded , files etc. so i have to tell my express app that what kind of data it will receive and how to handle it)
